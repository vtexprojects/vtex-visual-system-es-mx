> **Locale-scoped export** — this repo contains the Español México (ES-MX) slice of the VTEX Visual System design system (shared tokens/components/guidelines + only the `assets/images/es-mx/` image library). Generated from `VTEX Visual System_Git.zip`.
